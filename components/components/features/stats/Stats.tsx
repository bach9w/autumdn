  ...
  return (
    <div className="hidden overflow-hidden border-y border-zinc-700 bg-zinc-900/30 md:relative md:block">
      <div className="relative z-20 mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="flex flex-col items-center justify-center sm:flex-row md:gap-6">
          <Stat num={45} suffix="%" subheading="По-ниски цени" />
          <div className="h-[1px] w-12 bg-red-600 sm:h-12 sm:w-[1px]" />
          <Stat
            num={450}
            decimals={1}
            suffix="+"
            subheading="Доставени автомобили"
          />
          <div className="h-[1px] w-12 bg-red-600 sm:h-12 sm:w-[1px]" />
          <Stat num={200000} suffix="+" subheading="Постоянно налични обяви" />
        </div>
      </div>
