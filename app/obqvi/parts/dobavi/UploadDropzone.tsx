  ...
  return (
    <div
      className={
        ...
        twMerge(
          "flex flex-col items-center justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 text-center dark:border-gray-200/25",
      ...
      {files.length > 0 ? (
        <button
          className={twMerge(
            ...
            isUploading
              ? `before:absolute before:-z-20 before:h-full before:w-full before:bg-blue-400 ` +
                  `bg-blue-400 after:absolute after:left-0 after:-z-10 after:h-full after:bg-blue-600 ${progressWidths[uploadProgress]}`
              : "bg-blue-600",
          )}
